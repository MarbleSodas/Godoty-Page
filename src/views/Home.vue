...
const creditPackages = [
    {
        ...
        price: 5,
        credits: 5,
        priceId: 'price_1ScAkbGmQGk163sYaA52t1qi',
    ...
    },
    {
        ...
        price: 10,
        credits: 12,
        priceId: 'price_1ScAibGmQGk163sYydbNSl0s',
        features: ['12 Credits', 'Priority Support', 'No Expiry', '20% Bonus'],
        popular: true,
        badge: '$12 Value!'
    },
    {
        ...
        price: 20,
        credits: 25,
        priceId: 'price_1ScAcnGmQGk163sYDkFnyPAf',
        features: ['25 Credits', 'Priority Support', 'No Expiry', '25% Bonus'],
        popular: false,
        badge: 'Best Value!'
    }
]
                ...
                <template v-if="!loading">
                    ...
                    <template v-if="!user">
                        <button 
                            ...
                            class="hover:text-godoty-blue transition-colors"
                        >
                            Sign In
                        </button>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <form @submit.prevent="handleEmailAuth" class="space-y-4">
                        ...
                        <button 
                            type="submit"
                            :disabled="authLoading"
                            class="w-full py-3 bg-godoty-blue hover:bg-godoty-blueDim text-white font-semibold rounded-xl transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
                        >
            ...
            <div class="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                ...
                >
                    ...
                    <button 
                        ...
                        class="w-full py-3 rounded-xl transition-all font-semibold mt-auto"
